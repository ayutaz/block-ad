...
"#;
    ...
    assert!(
        engine
            .should_block("https://ads.example.com/banner")
            .should_block
    );
    assert!(
        engine
            .should_block("https://tracker.com/pixel")
            .should_block
    );
    assert!(
        engine
            .should_block("https://site.com/tracking/user")
            .should_block
    );
    assert!(
        !engine
...
"#;
    ...
    assert!(
        !engine
            .should_block("https://ads.com/acceptable/content")
            .should_block
    );
}
...
fn should_load_filter_list_from_file() {
    ...
    assert!(
        engine
            .should_block("https://malware.com/script")
            .should_block
    );
